...
CREATE TABLE `ofertas` (
  ...
  `modalidad` varchar(125) NOT NULL DEFAULT '',
  `fecha_publicación` date DEFAULT NULL,
  `fecha_cierre` date DEFAULT NULL,
  `maximo_postulantes` int(57) NOT NULL,
  `cantidad_postulantes` int(48) NOT NULL,
...
CREATE TABLE `postulaciones` (
  ...
  `fecha_de_postulacion` datetime(6) DEFAULT NULL,
...
CREATE TABLE `postulantes` (
  ...
  `teléfono` varchar(10) DEFAULT '',
  `dirección` varchar(128) NOT NULL DEFAULT '',
  `estado_civil` varchar(40) NOT NULL DEFAULT '',
